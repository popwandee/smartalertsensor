...
feathur_selection_data_by_date = df_to_train.loc['2022-01-01 01:00:00',['temperature','humidity','pressure','rain_hourly']]
water_level_data_in_date = df_to_train.loc['2022-01-01 01:00:00',['water_level']]
col1,col2 = st.columns(2)
with col1:
    st.write('Featuure selection data @ 2022-01-01 01:00:00',feathur_selection_data_by_date)
with col2:
